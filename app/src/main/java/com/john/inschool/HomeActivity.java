...
public class HomeActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_programs) {
            fragmentManager.beginTransaction().replace(R.id.content_frame , new Programsfragment()).commit();
            // Handle the camera action
        } else if (id == R.id.nav_gallery) {
            fragmentManager.beginTransaction().replace(R.id.content_frame , new Galleryfragment()).commit();

        } else if (id == R.id.nav_about_us) {
            fragmentManager.beginTransaction().replace(R.id.content_frame , new About_us_fragment()).commit();
