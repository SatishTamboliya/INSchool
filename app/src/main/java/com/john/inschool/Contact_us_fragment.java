 ...
 * {@link Contact_us_fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Contact_us_fragment#newInstance} factory method to
...
public class Contact_us_fragment extends Fragment {
     ...
     * @return A new instance of fragment Contact_us_fragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_contact_us_fragment, container, false);

        BannerSlider bannerSlider = (BannerSlider) rootView.findViewById(R.id.slider_programs);
        Button button = (Button) rootView.findViewById(R.id.feedback_queey);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.fragment_contact_us_fragment, new Contact_feedback_query_fragment()).addToBackStack(null).commit();
            }
        });
